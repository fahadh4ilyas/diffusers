...
async def generate_image(
    ...
    strength: Optional[float] = Body(None, examples=[None], ge=0.0, le=1.0),
    num_inference_steps: int = Body(50, gt=0),
    height: Optional[int] = Body(None, examples=[None], gt=0),
    width: Optional[int] = Body(None, examples=[None], gt=0),
):
    """
